...
const CLIP_MODE_DEFS = {
    ...
    [ClipMode.REDUCE_SIZE_OUTSIDE]: "clip_reduce_size_outside",
};
...
export class PointCloudMaterial extends RawShaderMaterial {
    ...
    uniforms: IPointCloudMaterialUniforms & Record<string, IUniform<any>> = {
        ...
        visibleNodes: makeUniform(
            "t",
            this.visibleNodesTexture || new Texture()
        ),
        ...
        highlightedPointColor: makeUniform(
            "fv",
            DEFAULT_HIGHLIGHT_COLOR.clone()
        ),
    ...
    @uniform("reduceSize") reduceSize!: number;
    ...
    @requiresShaderUpdate() pointSizeType: PointSizeType =
    ...
    constructor(parameters: Partial<IPointCloudMaterialParameters> = {}) {
        ...
        this.reduceSize = getValid(parameters.reduceSize, 1.0);
    ...
    set classification(value: IClassification) {
        ...
        if (this._classification === undefined) {
            ...
            for (const key of Object.keys(copy)) {
                ...
                isEqual =
                    isEqual && copy[key].equals(this._classification[key]);
            }
        }
    ...
    private updateVisibilityTextureData(nodes: PointCloudOctreeNode[]) {
        ...
        for (let i = 0; i < nodes.length; i++) {
            ...
            if (i > 0) {
                ...
                const parentOffset =
                    this.visibleNodeTextureOffsets.get(parentName)!;
    ...
    static makeOnBeforeRender(
        ...
        return (
            ...
            materialUniforms.pcIndex.value =
                pcIndex !== undefined
                    ? pcIndex
                    : octree.visibleNodes.indexOf(node);
